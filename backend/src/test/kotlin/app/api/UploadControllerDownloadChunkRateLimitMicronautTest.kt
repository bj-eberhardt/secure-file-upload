...
class UploadControllerDownloadChunkRateLimitMicronautTest : TestPropertyProvider {
    @Inject
    @field:Client("/")
    lateinit var client: HttpClient

    private val storageDir: Path = TestStorageDirs.createTempStorageDir("secure-file-upload-dlrl-it")
    ...
    @Test
    fun downloadChunk_secondRequestIs429_withRetryAfter() {
        ...
        val first = client.toBlocking().exchange(HttpRequest.GET<Any>("/api/v1/uploads/$id/chunks/0"), ByteArray::class.java)
