...
class SecurityHeadersFilterProdMicronautTest : TestPropertyProvider {
    @Inject
    @field:Client("/")
    lateinit var client: HttpClient

    private val storageDir: Path = TestStorageDirs.createTempStorageDir("secure-file-upload-prodheaders-it")
    ...
    @Test
    fun prodEnvironment_addsSecurityHeaders() {
        ...
        assertNotNull(headers.get("Referrer-Policy"))
